export const CLI_COMMANDS = [
  ...
  "sweep:record-inbox-page --feed inbox --source <id> [--collection <id>] [--work <recollection-work-id>] [--request-page-token <token>] [--next-page-token <token>] (--thread-ids <json-array> | --thread-ids-file <path>)",
  "sweep:abandon-inbox-collection --feed inbox --source <id> --collection <id> --reason <text> [--work <recollection-work-id>]",
  "sweep:finalize-inbox --feed inbox --source <id> --collection <id> (--snapshots <json-array> | --snapshots-file <path>) (--cards <json-array> | --cards-file <path>) (--checkpoint <json> | --checkpoint-file <path>) [--work <recollection-work-id>]",
